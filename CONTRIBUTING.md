...
## 🔀 Branching strategy
All git repositories in Astroberry Project follow simple yet effective branching strategy and feature branch workflow.
...
##### ✳️ Testing
- Test builds are made from testing branch.
- Testing branch is a copy of **development** branch.
- Testing branch uses testing debian repository.
- Test builds are used for QA and UAT testing purposes.
...
#### 3️⃣ Develop and Commit
- Work on your changes in the feature branch.
- Keep your commits atomic (one logical change per commit) with clear descriptive messages.
- Keep your changes minimal and focused.
- Do not introduce unrelated changes in the same pull request.

#### 4️⃣ The Pull Request (PR) to development
